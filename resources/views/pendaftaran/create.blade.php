...
<body class="page-body login-page login-form-fall">
	...
	<script src="{{ asset('templates/neon/assets/js/jquery.validate.min.js') }}"></script>
	<script src="{{ asset('templates/neon/assets/js/neon-register.js') }}"></script>
	<script src="{{ asset('templates/neon/assets/js/jquery.inputmask.bundle.js') }}"></script>
	...
	<!-- Demo Settings -->
	<script src="{{ asset('templates/neon/assets/js/neon-demo.js') }}"></script>
